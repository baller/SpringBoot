    ...
    <el-card style="width: 40%; margin-left: 120px; margin-top: 40px" >
      ...
      <el-form :model="form" ref="form" label-width="80px">
        ...
        <el-form-item label="身份">
            <span v-if="form.role==1" style="margin:5px">图书管理员</span>
            <span v-if="form.role==2" style="margin:5px">学生</span>
            <span v-if="form.role==3" style="margin:5px">教师</span>
            <span v-if="form.role==4" style="margin:5px">系统管理员</span>
        </el-form-item>
