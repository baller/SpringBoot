...
<!-- 搜索-->
    <div style="margin: 10px 0;">
      ...
      <el-button type="primary" style="margin-left: 1%" @click="load" size="mini">查询</el-button>
        ...
        <el-form-item>
            <el-button type="primary"  @click="add_user">添加读者</el-button>
        </el-form-item>
      </el-form>
    </div>
    <!-- 按钮-->
...
<!--    分页-->
    <div style="margin: 10px 0">
      ...
      <!-- 添加读者 -->
      <el-dialog v-model="dialogVisible_user" title="添加读者(默认密码:123456)" width="30%">
        <el-form :model="form_user" label-width="120px">
          <el-form-item label="用户名">
            <el-input style="width: 80%" v-model="form_user.username"></el-input>
          </el-form-item>
          <el-form-item label="昵称">
            <el-input style="width: 80%" v-model="form_user.nickName"></el-input>
          </el-form-item>
          <el-form-item label="电话号码">
            <el-input style="width: 80%" v-model="form_user.phone"></el-input>
          </el-form-item>
          <el-form-item label="性别">
            <div>
              <el-radio v-model="form_user.sex" label="男">男</el-radio>
              <el-radio v-model="form_user.sex" label="女">女</el-radio>
            </div>
          </el-form-item>
          <el-form-item label="地址">
            <el-input type="textarea" style="width: 80%" v-model="form_user.address"></el-input>
          </el-form-item>
        </el-form>
        <template #footer>
      <span class="dialog-footer">
...
export default {
  ...
  methods: {
    ...
    save_user(){
        ...
        this.form_user.role = 2
        request.post("/user/adduser",this.form_user).then(res =>{
          console.log(res)
          if(res.code == 0){
